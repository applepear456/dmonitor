...
urlpatterns = [
    ...
    url(r'^admin/monitor/microservice/debug_microservice/(\d+)$', views.debug_microservice, name='debug_microservice'),
    # 运行微服务路由

    url(r'^admin/monitor/case/debug_case/(\d+)$', views.debug_case, name='debug_case'),
    # 运行用例路由

    url(r'^admin/monitor/case/case_chart/(\d+)$', pyecharts_views.IndexView.as_view(), name='create_chart'),
